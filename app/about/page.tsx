...
export default function AboutPage() {
  return (
    <main className="min-h-screen px-4 py-12 max-w-2xl mx-auto">
      <h1 className="text-3xl font-bold mb-8 text-gray-900 dark:text-white">About BikeCompat</h1>

      <div className="space-y-8 text-gray-600 dark:text-gray-300 leading-relaxed">
        <section>
          <h2 className="text-lg font-semibold text-gray-900 dark:text-white mb-3">What is this?</h2>
          <p>
        ...
        <section>
          <h2 className="text-lg font-semibold text-gray-900 dark:text-white mb-3">Supported brands and systems</h2>
          <div className="space-y-4">
            {[
              ...
              <div key={brand}>
                <p className="font-medium text-gray-900 dark:text-white text-sm mb-1">{brand}</p>
                <ul className="text-sm text-gray-500 dark:text-gray-400 space-y-0.5 list-disc list-inside">
        ...
        <section>
          <h2 className="text-lg font-semibold text-gray-900 dark:text-white mb-3">Compatibility rules</h2>
          <ul className="text-sm space-y-2 text-gray-500 dark:text-gray-400 list-disc list-inside">
            ...
            <li>Shimano 11s and 12s are <strong className="text-gray-900 dark:text-white">not</strong> cross-compatible</li>
            ...
            <li>SRAM 11s and AXS 12s are <strong className="text-gray-900 dark:text-white">not</strong> cross-compatible</li>
            ...
            <li>Campagnolo 11s and 12s are <strong className="text-gray-900 dark:text-white">not</strong> cross-compatible (different freehub — N3W for 12s)</li>
            <li>Shimano, SRAM, and Campagnolo are <strong className="text-gray-900 dark:text-white">not</strong> mutually compatible (different cable pull ratios)</li>
          </ul>
        </section>

        <section>
          <h2 className="text-lg font-semibold text-gray-900 dark:text-white mb-3">Data sources &amp; accuracy</h2>
          <p className="text-sm">
        ...
        <section>
          <h2 className="text-lg font-semibold text-gray-900 dark:text-white mb-3">Affiliate disclosure</h2>
          <p className="text-sm">
        ...
        <section>
          <h2 className="text-lg font-semibold text-gray-900 dark:text-white mb-3">Roadmap</h2>
